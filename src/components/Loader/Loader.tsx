...
const Loader: React.FC<LoaderProps> = ({ size, className, color = '#518581' }: LoaderProps) => {
  return (
    <div className={className}>
      <svg className={`loader loader-${size}`} viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
